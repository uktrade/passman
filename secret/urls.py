...
urlpatterns = [
    ...
    path("secret/<str:pk>/mfa/setup/", views.SecretMFASetupView.as_view(), name="mfa_setup",),
    path("secret/<str:pk>/mfa/delete/", views.SecretMFADeleteView.as_view(), name="mfa_delete",),
    path("secret/<str:pk>/mfa/", views.SecretMFAView.as_view(), name="mfa",),
